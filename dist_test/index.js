...
$.run = run_1.run;
$.createEnvironment = symbol_1.createEnvironment;
$.switchEnvironment = symbol_1.switchEnvironment;
$.getCurrentEnvironment = symbol_1.getCurrentEnvironment;
$.listEnvironments = symbol_1.listEnvironments;
$.saveEnvironment = symbol_1.saveEnvironment;
$.restoreEnvironment = symbol_1.restoreEnvironment;
const builtin_fns = [
    'abs',
    'add',
    'adj',
