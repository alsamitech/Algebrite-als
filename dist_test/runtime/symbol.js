...
exports.withEnvironment = exports.restoreEnvironment = exports.saveEnvironment = exports.listEnvironments = exports.getCurrentEnvironment = exports.switchEnvironment = exports.createEnvironment = exports.clear_symbol = exports.clearRenamedVariablesToAvoidBindingToExternalScope = exports.iskeyword = exports.symbol = exports.collectUserSymbols = exports.clear_symbols = exports.reset_symbols = exports.get_binding = exports.set_binding = exports.get_printname = exports.usr_symbol = exports.std_symbol = exports.inChildScope = exports.Eval_symbolsinfo = void 0;
...
class EnvironmentManager {
    constructor() {
        ...
        this.savedEnvironments = new Map();
        this.currentEnvironmentName = 'default';
    ...
    saveEnvironment(envName, backupName) {
        ...
        for (const [name, sym] of env.symbols.entries()) {
            const binding = env.binding(sym);
            if (binding !== sym) {
                backup.set(name, binding);
            }
        }
        this.savedEnvironments.set(backupName, backup);
        return backupName;
    }
    restoreEnvironment(backupName) {
        ...
        for (const [name, value] of backup.entries()) {
            const sym = currentEnv.getOrCreate(name);
            currentEnv.set(sym, value);
        }
        return this.currentEnvironmentName;
    }
    withEnvironment(envName, fn) {
