...
const environment_1 = require("../sources/environment");
...
function defn() {
    ...
    symbol_1.std_symbol(defs_1.CREATEENVIRONMENT, environment_1.Eval_createEnvironment);
    ...
    symbol_1.std_symbol(defs_1.GETCURRENTENVIRONMENT, environment_1.Eval_getCurrentEnvironment);
    ...
    symbol_1.std_symbol(defs_1.LISTENVIRONMENTS, environment_1.Eval_listEnvironments);
    ...
    symbol_1.std_symbol(defs_1.RESTOREENVIRONMENT, environment_1.Eval_restoreEnvironment);
    symbol_1.std_symbol(defs_1.ROOTS, roots_1.Eval_roots);
    symbol_1.std_symbol(defs_1.ROUND, round_1.Eval_round);
    symbol_1.std_symbol(defs_1.SAVEENVIRONMENT, environment_1.Eval_saveEnvironment);
    ...
    symbol_1.std_symbol(defs_1.SWITCHENVIRONMENT, environment_1.Eval_switchEnvironment);
