...
function run(stringToBeRun, generateLatex = false, environment) {
    let p1, p2;
    ...
    if (environment) {
        return symbol_1.withEnvironment(environment, () => executeInCurrentEnvironment());
    }
    else {
        return executeInCurrentEnvironment();
    }
    function executeInCurrentEnvironment() {
        let n = 0;
        let indexOfPartRemainingToBeParsed = 0;
        let allReturnedPlainStrings = '';
        let allReturnedLatexStrings = '';
