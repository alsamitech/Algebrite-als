...
export const CREATEENVIRONMENT = 'createEnvironment';
...
export const GETCURRENTENVIRONMENT = 'getCurrentEnvironment';
...
export const LISTENVIRONMENTS = 'listEnvironments';
...
export const RESTOREENVIRONMENT = 'restoreEnvironment';
export const ROUND = 'round';
export const YYRECT = 'rect';
export const ROOTS = 'roots';
export const SAVEENVIRONMENT = 'saveEnvironment';
...
export const SWITCHENVIRONMENT = 'switchEnvironment';
